  ...
  render(){
    return (
      <div>
        ...
        <button type="button" classname="pure-button pure-button-primary" onClick={this.handleclear}>Sign in</button>
    </fieldset>
</form>
      </div>
    )
...
ReactDOM.render(<Root2/>, document.getElementById('hello'));